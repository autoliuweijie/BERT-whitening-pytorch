...
from senteval.sick import SICKRelatednessEval, SICKEntailmentEval, SICKRelatednessCosinEval
from senteval.mrpc import MRPCEval
from senteval.sts import STS12Eval, STS13Eval, STS14Eval, STS15Eval, STS16Eval, STSBenchmarkEval, STSBenchmarkCosinEval
...
class SE(object):
    def __init__(self, params, batcher, prepare=None):
        ...
        self.list_tasks = ['CR', 'MR', 'MPQA', 'SUBJ', 'SST2', 'SST5', 'TREC', 'MRPC',
                           'SICKRelatedness', 'SICKEntailment', 'SICKRelatednessCosin', 'STSBenchmark', 'STSBenchmarkCosin',
    ...
    def eval(self, name):
        ...
        elif name == 'SICKRelatednessCosin':
            self.evaluation = SICKRelatednessCosinEval(tpath + '/downstream/SICK', seed=self.params.seed)
        elif name == 'STSBenchmarkCosin':
            self.evaluation = STSBenchmarkCosinEval(tpath + '/downstream/STS/STSBenchmark', seed=self.params.seed)
